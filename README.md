# 2020년 1학기 한림대학교 소프트융합대학 CapstoneDesign :+1:  
...
### [딥러닝 영상처리 기반의 스마트 주차장 시스템](https://github.com/YeongSeokJeong/smart_parking_lot)
  ...
  * 참여기업 : 지오비전
  * 지도교수 : 김유섭
### [라즈베리파이로 젤독용 영상 스트리밍 서비스 구현](https://github.com/mjk9607/2020BigDataCapstoneDesign1)
  * 팀명 : GelDoc
  * 팀원 : 김민재 
  * 참여기업 : (주)바이오메듀스
  * 지도교수 : 김종대 
...
### [OpenCV 및 머신러닝 학습을 이용한 수도쿠 문제 해결(1팀)](https://github.com/LeeSooHyung/opencv_1/)
  * 팀명 : 으랏차차
  * 팀원 : 이수형, 권희원, 김승연, 백지연, 권희원,정진환, 조상호 
  * 참여기업 : 지오비전
  * 지도교수 : 노원종
### [OpenCV 및 머신러닝 학습을 이용한 수도쿠 문제 해결(2팀)](https://github.com/shin950924) 
  ...
  * 참여기업 : 지오비전
  * 지도교수 : 노원종
### 라즈베리파이를 이용한 열화상카메라 체열온도 측정시스템 (깃주소x)
  * 팀명 : heat다, heat 
  * 팀원 : 박성민, 정회웅
  * 참여기업 : 에이엔디
  * 지도교수 : 송성호 
...
### [딥러닝을 활용한 애플리케이션 개발](https://github.com/HyeonGyuChi/CapstoneDesign20201) 
  ...
  * 참여기업 : 지오비전  
  * 지도교수 : 임성훈
### [IoT 디바이스를 위한 보안 프로토콜 개발(공개 레파지토리에서 배포되는 악성코드를 자동화 탐지)](https://github.com/LHaEun/LHaEun)
  * 팀명 : IDDs_a
  * 팀원 : 이하은
  * 참여기업 : 현대오토에버  
  * 지도교수 : 조효진
